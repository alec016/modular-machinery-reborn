...
public class RegisterEmiRequirementToIngredientEvent extends MMREvent<RequirementType<?, ?, ?>, EmiIngredientFactory<?, ?, ?, ?>> {
  ...
  public <
      ...
      X
  > void register(RequirementType<C, T, X> requirement, EmiIngredientFactory<R, C, T, X> factory) {
